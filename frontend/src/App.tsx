...
import {
  ...
  teamsSportCreate,
  teamsSportEdit,
} from './resources/teamsSport';
import { matchList, matchCreate, matchEdit } from './resources/match';
import {
  pointTableList,
  pointTableCreate,
  pointTableEdit,
} from './resources/pointTable';
import usersIcon from '@mui/icons-material/AccountCircle';
import teamsSportIcon from '@mui/icons-material/SportsSoccer';
import matchIcon from '@mui/icons-material/Event';
import pointTableIcon from '@mui/icons-material/BarChart';
// SUPERTOKENS
...
const App = () => (
  <SuperTokensWrapper>
    <BrowserRouter basename="/a434d70ca">
      <Admin
        authProvider={
      ...
      >
        ...
        <Resource
          name="teamsSport"
          options={{ label: 'Teams Sport' }}
          list={teamsSportList}
          create={teamsSportCreate}
          edit={teamsSportEdit}
        ...
        <Resource
          name="pointTable"
          options={{ label: 'Point Table' }}
          list={pointTableList}
          create={pointTableCreate}
          edit={pointTableEdit}
